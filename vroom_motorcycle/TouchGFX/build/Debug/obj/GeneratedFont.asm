; Listing generated by Microsoft (R) Optimizing Compiler Version 19.38.33133.0 
	...
	TITLE	C:\STM32CubeIDE\Electrium\vroom_motorcycle\TouchGFX\build\Debug\obj\GeneratedFont.obj
	.686P
	.XMM
	include listing.inc
	.model	flat
...
__A9711CC5_GeneratedFont@cpp DB 01H
msvcjmc	ENDS
...
; _this$ = ecx
; File C:\STM32CubeIDE\Electrium\vroom_motorcycle\TouchGFX\generated\fonts\src\GeneratedFont.cpp
; Line 46
	push	ebp
	mov	ebp, esp
	...
	mov	ecx, OFFSET __A9711CC5_GeneratedFont@cpp
...
; _this$ = ecx
; File C:\STM32CubeIDE\Electrium\vroom_motorcycle\TouchGFX\generated\fonts\include\fonts\GeneratedFont.hpp
; Line 28
	push	ebp
	mov	ebp, esp
	sub	esp, 204				; 000000ccH
	...
	pop	ecx
	mov	DWORD PTR _this$[ebp], ecx
	mov	ecx, OFFSET __D70182D5_GeneratedFont@hpp
	call	@__CheckForDebuggerJustMyCode@4
; Line 29
	mov	eax, DWORD PTR _this$[ebp]
